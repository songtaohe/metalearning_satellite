...
class MAML(object):
	def __init__(self, sess, num_test_updates = 20, inner_lr = 0.001):
		...
		with tf.variable_scope("foo", reuse=True):
			self.baseline_output, _ = CNNmodel.build_unet512_12_V1(self.inputA, prefix="first_", deconv=True)

		self.baseline_loss = CrossEntropy(self.baseline_output, self.outputA)
...
if __name__ == "__main__":
	...
	name = "ModelV1_20180404_boston_la_chicago_converge"
	...
	with tf.Session() as sess:
		...
		for i in xrange(5):
			...
			testCase.append(dataloader.getTestBatchs(5,20))
