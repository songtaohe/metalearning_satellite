...
class MAMLFirstOrder(MAMLBase):
	def __init__(self, sess, num_test_updates = 20, inner_lr = 0.001):
		super().__init__(num_test_updates, inner_lr, CNNmodel.buildMetaBlockV1, CNNmodel.build_unet512_12_V1, build_cnn_model = build_unet512_12_V1_fixed, run_cnn_model = run_unet512_12_V1_fixed)
